...
public interface MechanicCrudService {
     ...
     */
    MechanicDto addMechanic(MechanicDto dto) throws BusinessException;
     ...
     */
    void deleteMechanic(String mechanicId) throws BusinessException;
     ...
     *                                  name, surname fields is null or blank
     */
    void updateMechanic(MechanicDto dto) throws BusinessException;
     ...
     */
    Optional<MechanicDto> findMechanicByNif(String nif)
        throws BusinessException;

    /**
     * @return the list of all mechanics without regarding their contract state
     *         or if they have contract or not. It might be an empty list if
