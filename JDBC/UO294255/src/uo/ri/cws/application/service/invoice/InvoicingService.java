...
public interface InvoicingService {
     ...
     * @param charges,   a Map<String, Double> whose: - Key (String) represents
     ...
     *
     * @throws IllegalArgumentException if - invoiceId is null - charges is null
     *                                  - charges is empty - any of the payment
     *                                  mean ids is null - any of the amounts is
     *                                  null
     */
