...
public class WorkOrderJpaRepository
    ...
    @Override
    public List<WorkOrder> findNotInvoicedWorkOrdersByClientNif(
        String client_nif) {
        return Jpa.getManager()
            .createNamedQuery("WorkOrder.findNotInvoicedWorkOrdersByClientNif", WorkOrder.class)
            .setParameter( 1, client_nif )
            .getResultList();
    }
